          ...
          <table className="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
            <thead>
              <tr>
                ...
                <th scope="col" className="px-3 py-3.5 text-right text-sm font-semibold text-gray-900 dark:text-white">SOL Amount</th>
                ...
                <tr key={tx.signature}>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-0">
                    <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium
                      ${tx.type === 'buy' ? 'bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20' : ''}
                      ${tx.type === 'sell' ? 'bg-red-50 dark:bg-red-500/10 text-red-700 dark:text-red-400 ring-1 ring-inset ring-red-600/20' : ''}
                      ${tx.type === 'transfer' ? 'bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400 ring-1 ring-inset ring-blue-600/20' : ''}
                    `}>
                  ...
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-right text-gray-500 dark:text-gray-400">{formatNumber(tx.sol_amount)}</td>
