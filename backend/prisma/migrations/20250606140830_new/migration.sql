/*
  ...
  - You are about to drop the column `average_acquisition_price` on the `TokenHolder` table. All the data in the column will be lost.
...
INSERT INTO "new_Transaction" ("blockTime", "destination_wallet_id", "id", "signature", "solAmount", "source_wallet_id", "tokenAmount", "type") SELECT "blockTime", "destination_wallet_id", "id", "signature", "solAmount", "source_wallet_id", "tokenAmount", "type" FROM "Transaction";
